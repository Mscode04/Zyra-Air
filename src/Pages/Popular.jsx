...
import '../App.css';
import { bgPop,imageList,Cartadd,Heart} from '../Database/Products';
function Popular({cart,setcart,fav,setfav}) {
  ...
  return (
    ...
    >
      <div className="main flex flex-col items-center p-5 bg-slate-600 opacity-55 -mt-6 h-full -ml-10 -mr-10">
        <h1 className='text-slate-300 text-5xl font-bold mb-32 mt-32'>All Product</h1>
